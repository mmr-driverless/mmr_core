...
// AUTONOMOUS_STATE
  ...
  MMR_CAN_MESSAGE_ID_MMR_AS_READY,
  MMR_CAN_MESSAGE_ID_AS_DRIVING,
  MMR_CAN_MESSAGE_ID_MMR_AS_OFF,
// !AUTONOMOUS_STATE
// MANUAL_MISSION
...
// STEERING
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ERROR_LEFT_X = 256,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ERROR_RIGHT_X,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ODOMETRY_MIN_SPEED_LEFT_X,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ODOMETRY_MIN_SPEED_LEFT_Y,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ODOMETRY_MIN_SPEED_RIGHT_X,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ODOMETRY_MIN_SPEED_RIGHT_Y,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ODOMETRY_MAX_SPEED_LEFT_Y,
  MMR_CAN_MESSAGE_ID_D_PROPORTIONAL_ODOMETRY_MAX_SPEED_RIGHT_Y,
  MMR_CAN_MESSAGE_ID_D_RISE_CUTOFF_FREQUENCY,
  MMR_CAN_MESSAGE_ID_D_STEERING_CENTER_AUTOSET,
  MMR_CAN_MESSAGE_ID_D_STEERING_CENTER_AUTOSET_OK,
  MMR_CAN_MESSAGE_ID_D_CURRENT_ANGLE,
